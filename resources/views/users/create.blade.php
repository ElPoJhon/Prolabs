                ...
                <form method="post" action="{{ route('users.store') }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="cedula" class="block font-medium text-sm text-gray-700">Cedula</label>
                            <input type="text" name="cedula" id="cedula" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('cedula', '') }}" />
                            @error('cedula')
